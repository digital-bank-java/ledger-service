...
public class SecurityConfiguration {
    ...
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http, LedgerSecurityProblemSupport problemSupport)
            throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(
                                ...
                                "/swagger-ui.html")
                        .permitAll()
                        .requestMatchers("/internal/v1/ledger-entries/**")
                        .hasAuthority("SCOPE_ledger.internal")
                        .anyRequest()
                        .denyAll())
